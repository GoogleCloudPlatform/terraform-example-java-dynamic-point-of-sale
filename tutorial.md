...
We also strongly recommend that you familiarize yourself with the Analytics Lakehouse solution by reading the [solution guide](https://cloud.google.com/architecture/big-data-analytics/dynamic-java-web-application).
